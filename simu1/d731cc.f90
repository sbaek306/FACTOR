...
module SDRCFunctionsVar
  ...
  integer, parameter :: tt=1000
	...
	integer, parameter :: samplen=700, d=1, p=5, p1=d*(p-d),lw=p1*(p1*3+13),lwt = 2*(2*3+13)
...
!  parasTrue(10,1)= 0.0 
  ...
  open(1,file='d731cc_est.txt')
  open(2,file='d731cc_var.txt')
